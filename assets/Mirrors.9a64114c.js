...
`,[V("border",`
 ...
 `))]);const $n=Object.assign(Object.assign({},ve.props),{size:String,checked:{type:[Boolean,String,Number],default:void 0},defaultChecked:{type:[Boolean,String,Number],default:!1},value:[String,Number],disabled:{type:Boolean,default:void 0},indeterminate:Boolean,label:String,focusable:{type:Boolean,default:!0},checkedValue:{type:[Boolean,String,Number],default:!0},uncheckedValue:{type:[Boolean,String,Number],default:!1},"onUpdate:checked":[Function,Array],onUpdateChecked:[Function,Array],privateTableHeader:Boolean,onChange:[Function,Array]});var Lt=X({name:"Checkbox",props:$n,setup(e){const{mergedClsPrefixRef:t}=Ie(e),o=Qe(e,{mergedSize(f){const{size:h}=e;if(h!==void 0)return h;if(l){const{value:b}=l.mergedSizeRef;if(b!==void 0)return b}if(f){const{mergedSize:b}=f;if(b!==void 0)return b.value}return"medium"},mergedDisabled(f){const{disabled:h}=e;if(h!==void 0)return h;if(l){if(l.disabledRef.value)return!0;const{maxRef:{value:b},checkedCountRef:F}=l;if(b!==void 0&&F.value>=b&&!x.value)return!0;const{minRef:{value:$}}=l;if($!==void 0&&F.value<=$&&x.value)return!0}return f?f.disabled.value:!1}}),{mergedDisabledRef:n,mergedSizeRef:r}=o,l=Te(ko,null),i=B(e.defaultChecked),d=ne(e,"checked"),p=Ee(d,i),x=Ue(()=>{if(l){const f=l.valueSetRef.value;return f&&e.value!==void 0?f.has(e.value):!1}else return p.value===e.checkedValue}),y=ve("Checkbox","Checkbox",_n,hr,e,t);function u(f){if(l&&e.value!==void 0)l.toggleCheckbox(!x.value,e.value);else{const{onChange:h,"onUpdate:checked":b,onUpdateChecked:F}=e,{nTriggerFormInput:$,nTriggerFormChange:T}=o,s=x.value?e.uncheckedValue:e.checkedValue;b&&D(b,s,f),F&&D(F,s,f),h&&D(h,s,f),$(),T(),i.value=s}}function C(f){n.value||u(f)}function c(f){if(!n.value)switch(f.code){case"Space":case"Enter":case"NumpadEnter":u(f)}}function v(f){switch(f.code){case"Space":f.preventDefault()}}return Object.assign(o,{mergedClsPrefix:t,mergedDisabled:n,renderedChecked:x,mergedTheme:y,labelId:no(),handleClick:C,handleKeyUp:c,handleKeyDown:v,cssVars:z(()=>{const{value:f}=r,{common:{cubicBezierEaseInOut:h},self:{borderRadius:b,color:F,colorChecked:$,colorDisabled:T,colorTableHeader:s,colorTableHeaderModal:g,colorTableHeaderPopover:P,checkMarkColor:_,checkMarkColorDisabled:L,border:I,borderFocus:j,borderDisabled:Z,borderChecked:Y,boxShadowFocus:te,textColor:ae,textColorDisabled:S,checkMarkColorDisabledChecked:w,colorDisabledChecked:m,borderDisabledChecked:O,labelPadding:N,[de("fontSize",f)]:W,[de("size",f)]:le}}=y.value;return{"--size":le,"--bezier":h,"--border-radius":b,"--border":I,"--border-checked":Y,"--border-focus":j,"--border-disabled":Z,"--border-disabled-checked":O,"--box-shadow-focus":te,"--color":F,"--color-checked":$,"--color-table-header":s,"--color-table-header-modal":g,"--color-table-header-popover":P,"--color-disabled":T,"--color-disabled-checked":m,"--text-color":ae,"--text-color-disabled":S,"--check-mark-color":_,"--check-mark-color-disabled":L,"--check-mark-color-disabled-checked":w,"--font-size":W,"--label-padding":N}})})},render(){const{$slots:e,renderedChecked:t,mergedDisabled:o,indeterminate:n,privateTableHeader:r,cssVars:l,labelId:i,label:d,mergedClsPrefix:p,focusable:x,handleKeyUp:y,handleKeyDown:u,handleClick:C}=this;return a("div",{class:[`${p}-checkbox`,t&&`${p}-checkbox--checked`,o&&`${p}-checkbox--disabled`,n&&`${p}-checkbox--indeterminate`,r&&`${p}-checkbox--table-header`],tabindex:o||!x?void 0:0,role:"checkbox","aria-checked":n?"mixed":t,"aria-labelledby":i,style:l,onKeyup:y,onKeydown:u,onClick:C,onMousedown:()=>{const c=v=>{v.preventDefault()};window.addEventListener("selectstart",c),setTimeout(()=>{window.removeEventListener("selectstart",c)},0)}},a("div",{class:`${p}-checkbox-box`},a(fr,null,{default:()=>this.indeterminate?a("div",{key:"indeterminate",class:`${p}-checkbox-icon`},Mn):a("div",{key:"check",class:`${p}-checkbox-icon`},Tn)}),a("div",{class:`${p}-checkbox-box__border`})),d!==null||e.default?a("span",{class:`${p}-checkbox__label`,id:i},Ne(e,"default",void 0,()=>[d])):null)}}),In=K([R("select",`
 z-index: auto;
 outline: none;
 width: 100%;
 position: relative;
